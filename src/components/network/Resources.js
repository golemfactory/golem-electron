                ...
                <div
                    ...
                    {!toggleAdvanced ? (
                        <div className="slider__tips">
                            ...
                            resources (CPU, RAM and disk space) Golem can use.
                            More power means more potential income.
                        </div>
                    ) : (
                        <div className="slider__tips">
                            Allocate your machine's resources exactly as you
                            like.
                            <br />
                            Remember that if you give Golem all of you
                            processing power,
                            <br />
