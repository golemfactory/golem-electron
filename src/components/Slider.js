...
export default class Slider extends React.Component {
    ...
    _handleFillLower(isDisabled) {
        ...
        const indicator = document.getElementById(
            `${this.props.inputId}__indicator`
        );
        const iconOffset =
                ...
                <Tooltip
                    ...
                    <div className="slider">
                        {iconLeft ? (
                            ...
                            <span className="slider-text--left">
                                {textLeft}
                            </span>
                        ) : (
                            ""
                        ...
                        />
                        <span
                            className="slider-indicator__resources"
                            id={`${this.props.inputId}__indicator`}
                        />
                        {iconRight ? (
                            <span className={`slider-icon ${iconRight}`} />
                        ) : textRight ? (
                            <span className="slider-text--right">
                                {textRight}
                            </span>
                        ) : (
                            ""
