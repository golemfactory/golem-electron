...
export default class DepositTimeModal extends React.Component {
    ...
    _handleCancel = () => {
        this.props.closeModal("depositTimeModal")
    }
            ...
            <div className="container__modal container__deposit-time-modal">
                <div className="content__modal">
                    ...
                    <div className="deposit-time__desc">
                        <span>Due to current high gas prices, we cannot guarantee that Deposit creation time will be acceptable.</span>
                    </div>
                    <div className="deposit-time__tips">
                        <span>
                            We strongly recommend commisioning this task without Concent Service. 
                            If you want to compute with Concent Service wait for the gas price to normalize.
                        </span>
                    </div>
                    <div className="checkbox-item">
                        ...
                        <label htmlFor="concentTaskCheckbox" className="checkbox-label-left">
                            Compute this task with{!isTaskWithoutConcent ? "" : "out"} concent.
                        </label>
                    </div>
