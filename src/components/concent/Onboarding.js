                ...
                <div className="concent-onboarding__action-container">
                    ...
                    <div>
                        <span 
                            ...
                            onClick={currentStep === 5 ? ::this._handlePrev : this._handleCancel}>
                            {currentStep === 5 ? "Back" : "Skip"}
                        </span>
                        <button 
                            className="btn btn--primary" 
                            onClick={currentStep === 5 ? this._handleDone : this._handleNext}>
                    ...
                    <div>
                        <span 
                            ...
                            aria-label="Prev" 
                            tabIndex="0"/>
                        <span className="page-indicator">{currentStep - 1} of 4</span>
                        <span
