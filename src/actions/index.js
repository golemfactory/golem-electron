...
const {ONBOARDING, UPDATE_NODE_NAME,
    ...
    //SETTINGS
    SET_FILE_LOCATION, SET_PERFORMANCE_CHARTS, RECOUNT_BENCHMARK, SET_PROV_MIN_PRICE, SET_REQ_MAX_PRICE, SET_AVATAR, SET_NODE_NAME, SET_PROV_TRUST, SET_REQ_TRUST, SET_NET_PROV_TRUST, SET_NET_REQ_TRUST, SET_TASK_STATS,
    //FRAME WINDOW
    SET_ALL_FRAMES, SET_FRAMES_WITH_SUBTASKS, SET_SUBTASKS_BORDER, SET_PREVIEW_LIST, SET_SUBTASKS_LIST, FETCH_SUBTASKS_LIST, SET_SUBTASKS_VISIBILITY, SET_FRAME_ID, SET_FRAME_INDEX, NEXT_FRAME, PREVIOUS_FRAME,

    //GENERAL
    START_GOLEM, STOP_GOLEM, CONTINUE_WITH_PROBLEM, SET_GOLEM_STATUS, SET_GOLEM_PAUSE_STATUS, START_LOADING, END_LOADING, LOGIN, LOGOUT, LOGIN_FRAME, LOGOUT_FRAME, SET_AUTOLAUNCH, SET_CONNECTED_PEERS, SET_PREVIEW_RADIO, SET_PREVIEW_EXPANDED, SET_CURRENCY, UPLOAD, SET_ZOOM_RATIO, SET_NETWORK_INFO,
    //ERROR
