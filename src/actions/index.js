...
const {ONBOARDING,
    ...
    //TASKS
    SET_TASKLIST, SET_TASK_DETAILS, GET_TASK_DETAILS, SET_TASK_INFO, SET_PREVIEW, DELETE_TASK, CREATE_TASK, RUN_TEST_TASK, GET_ESTIMATED_COST, SET_ESTIMATED_COST, CLEAR_TASK_PLAIN, GET_TASK_PRESETS, SET_TASK_PRESETS, SAVE_TASK_PRESET, DELETE_TASK_PRESET, SET_FOOTER_INFO,
    //SETTINGS
    ...
    //FRAME WINDOW
    SET_ALL_FRAMES, SET_FRAMES_WITH_SUBTASKS, SET_SUBTASKS_BORDER, SET_SUBTASKS_VISIBILITY,
    //GENERAL
    START_LOADING, END_LOADING, LOGIN, LOGOUT, LOGIN_FRAME, LOGOUT_FRAME, SET_AUTOLAUNCH, SET_CONNECTED_PEERS, SET_PREVIEW_RADIO, SET_PREVIEW_EXPANDED, SET_CURRENCY, UPLOAD, SET_ZOOM_RATIO, SET_NETWORK_INFO,
    //ERROR
...
export const setEstimatedCoset = (payload) => ({
