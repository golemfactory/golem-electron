export let dict = Object.freeze({
    ...
    SET_ADVANCED_FROM_RESOURCE: 'SET_ADVANCED_FROM_RESOURCE',
    //TASKS
...
const {ONBOARDING,
    //NETWORK
    SET_BALANCE, SET_RESOURCES, SET_HISTORY, SET_SYSTEM_INFO, SET_ADVANCED_PRESET, CREATE_ADVANCED_PRESET, DELETE_ADVANCED_PRESET, SET_ADVANCED_CHART, SET_CHOSEN_HARDWARE_PRESET, SET_ADVANCED_FROM_RESOURCE,
    //TASKS
    SET_TASKLIST, SET_TASK_DETAILS, GET_TASK_DETAILS, SET_TASK_INFO, SET_PREVIEW, DELETE_TASK, CREATE_TASK, CLEAR_TASK_PLAIN,
    //SETTINGS
    SET_FILE_LOCATION, SET_PERFORMANCE_CHARTS, RECOUNT_BENCHMARK, SET_PROV_MIN_PRICE, SET_REQ_MAX_PRICE, SET_AVATAR, SET_PROFILE_CHARTS, SET_NODE_NAME, SET_PROV_TRUST, SET_REQ_TRUST,
    //FRAME WINDOW
    SET_ALL_FRAMES, SET_FRAMES_WITH_SUBTASKS, SET_CONNECTED_PEERS,
    //GENERAL
    START_LOADING, END_LOADING, LOGIN, LOGOUT, LOGIN_FRAME, LOGOUT_FRAME, SET_AUTOLAUNCH, SET_PREVIEW_RADIO, SET_PREVIEW_EXPANDED, SET_CURRENCY, UPLOAD, SET_ZOOM_RATIO, SET_NETWORK_INFO,
    //ERROR
...
export const setAdvancedFromResource = (payload) => ({
    type: SET_ADVANCED_FROM_RESOURCE,
    payload
})
