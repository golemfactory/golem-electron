...
const {ONBOARDING, UPDATE_NODE_NAME,
    ...
    //FRAME WINDOW
    SET_ALL_FRAMES, SET_FRAMES_WITH_SUBTASKS, SET_SUBTASKS_BORDER, SET_PREVIEW_LIST, SET_SUBTASKS_LIST, SET_SUBTASKS_VISIBILITY, SET_FRAME_ID, NEXT_FRAME, PREVIOUS_FRAME,
    //GENERAL
    SET_GOLEM_VERSION, START_GOLEM, STOP_GOLEM, CONTINUE_WITH_PROBLEM, SET_GOLEM_STATUS, SET_GOLEM_PAUSE_STATUS, START_LOADING, END_LOADING, LOGIN, LOGOUT, LOGIN_FRAME, LOGOUT_FRAME, SET_AUTOLAUNCH, SET_CONNECTED_PEERS, SET_PREVIEW_RADIO, SET_PREVIEW_EXPANDED, SET_CURRENCY, UPLOAD, SET_ZOOM_RATIO, SET_NETWORK_INFO,
    //ERROR
