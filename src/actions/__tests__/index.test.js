...
describe('actions', () => {
    ...
    it('should create an action to setSubtasksBorder', () => {
        ...
        const expectedAction = {
            payload: payload,
            type: actions.dict.SET_SUBTASKS_BORDER
        };
        expect(actions.setSubtasksBorder(payload)).toEqual(expectedAction);
    });
    ...
    it('should create an action to setSubtasksVisibility', () => {
        ...
        const expectedAction = {
            payload: payload,
            type: actions.dict.GET_SUBTASKS_BORDER
        };
        expect(actions.getSubtasksBorder(payload)).toEqual(expectedAction);
    });
    ...
    it('should create an action to setProviderMinPrice', () => {
        ...
        expect(actions.setProviderMinPrice(payload, init)).toEqual(
            expectedAction
        );
    });
    ...
    it('should create an action to setRequestorMaxPrice', () => {
        ...
        expect(actions.setRequestorMaxPrice(payload, init)).toEqual(
            expectedAction
        );
    });
    ...
    it('should create an action to setRequestorTrust', () => {
        ...
        expect(actions.setRequestorTrust(payload, init)).toEqual(
            expectedAction
        );
    });
    ...
    it('should create an action to setNetworkProviderTrust', () => {
        ...
        expect(actions.setNetworkProviderTrust(payload)).toEqual(
            expectedAction
        );
    });
    ...
    it('should create an action to setNetworkRequestorTrust', () => {
        ...
        expect(actions.setNetworkRequestorTrust(payload)).toEqual(
            expectedAction
        );
    });
