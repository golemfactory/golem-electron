...
module.exports = (env, argv) => ({
  ...
  plugins: [
    new LodashModuleReplacementPlugin({
      collections: true, // enable object iteration
      currying: true,
      flattening: true,
      placeholders: true,
      shorthands: true // fp/flow shorthands support
    }),
      ...
      loaders: [
        {
          ...
          options: {
            ...
            plugins: [
              ...
              argv.mode === modes.DEV ? 'react-hot-loader/babel' : false,
    ...
    process.env.ANALYZE && new BundleAnalyzerPlugin() // <--- Cool stuff to see package size of the modules
  ].filter(Boolean),
  module: {
    rules: [
      {
